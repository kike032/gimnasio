...
<% request.setAttribute("activePage", "comprobantes"); %>
<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>IronCore — Comprobantes</title>
  ...
  <div id="mainContent">
    <div class="topbar">
      <div class="topbar-left">
        <div class="page-title">Comprobantes</div>
        <div class="page-sub">Comprobantes de pago emitidos</div>
      </div>
    </div>
    <div class="table-card">
      <div class="table-toolbar">
        <span class="table-toolbar-title">Lista de comprobantes</span>
      </div>
      <div id="listaComprobantes" class="lista-tabla">
      ...
      <div class="pagination-bar">
        <span class="pag-info">Mostrando 1–10 de 107 comprobantes</span>
        <div class="pag-btns">
