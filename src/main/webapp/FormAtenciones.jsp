  ...
  <div id="mainContent">
    <div class="topbar">
      <div class="topbar-left">
        ...
        <div class="page-sub">Registro de atenciones y solicitudes</div>
      </div>
    </div>
    <div class="table-card">
      <div class="table-toolbar">
        <span class="table-toolbar-title">Lista de atenciones</span>
      </div>
      <div id="listaAtenciones" class="lista-tabla">
      ...
      <div class="pagination-bar">
        <span class="pag-info">Mostrando 1–10 de 45 atenciones</span>
        <div class="pag-btns">
