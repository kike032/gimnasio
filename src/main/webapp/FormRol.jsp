  ...
  <div id="mainContent">
    <div class="topbar">
      <div class="topbar-left">
        ...
        <div class="page-sub">Gestión de roles y permisos</div>
      </div>
    </div>
    <div class="table-card">
      ...
      <div id="listaRol" class="lista-tabla">
      ...
      <div class="pagination-bar">
        <span class="pag-info">Mostrando 1–4 de 4 roles</span>
        <div class="pag-btns">
