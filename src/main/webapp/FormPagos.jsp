<%-- 
    Document   : FormPagos
    Created on : 7 may 2026, 22:32:15
    Author     : kikej
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<% request.setAttribute("activePage", "pagos"); %>
<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>IronCore — Pagos</title>
  ...
  <div id="mainContent">
    <div class="topbar">
      <div class="topbar-left">
        ...
        <div class="page-sub">Historial de pagos registrados</div>
      </div>
    </div>
    <div class="table-card">
      <div class="table-toolbar">
        <span class="table-toolbar-title">Lista de pagos</span>
      </div>
      <div id="listaPagos" class="lista-tabla">
      ...
      <div class="pagination-bar">
        <span class="pag-info">Mostrando 1–10 de 107 pagos</span>
        <div class="pag-btns">
